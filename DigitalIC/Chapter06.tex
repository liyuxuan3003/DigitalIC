...
现在的问题是，比反相器更复杂的组合逻辑是如何设计的？总的而言，有两个可行的方向，分别称为“\uwave{静态CMOS电路}”和“\uwave{动态CMOS电路}”。而更进一步的，静态CMOS电路又可以细分为三类：互补CMOS逻辑、伪NMOS逻辑、传输管逻辑。其中，静态互补CMOS逻辑是完整了继承静态互补CMOS反相器的设计思想，事实上，这也是最可靠的设计方案，但需要使用的晶体管数目较多。其他的设计方案，几乎都是围绕如何以性能为代价减少晶体管数目。
