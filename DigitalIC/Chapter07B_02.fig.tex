...
\xValDefine{yA}[+1]
\xValMiddle{yC}{yA}{yB}
\xValProportion{yI}{yA}{yB}[0.7]
\xValOffset{yBorB}{yB}[-1.00]
\xValOffset{yBorA}{yA}[+2.20]

\xGeneratePoints{xL,xR,xBorL,xBorR,xC,xPal,xPbl,xPcl,xPclA,xPclB,xPar,xPbr,xPcr,xPcrA,xPcrB}{yB,yA,yC,yBorB,yBorA,yI}
...
\path (xPcl/yI) node[not port,rotate=180] (I2l) {} node[above=0.25cm] {$I_2$}; 
\path (xPcr/yI) node[not port,rotate=180] (I2r) {} node[above=0.25cm] {$I_2'$}; 
...
\draw (xPclB/yA) node[circ] {} |- (I2l.in);
\draw (xPclA/yA) node[circ] {} |- (I2l.out);
\draw (xPcrB/yA) node[circ] {} |- (I2r.in);
\draw (xPcrA/yA) node[circ] {} |- (I2r.out);
