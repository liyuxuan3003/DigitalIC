...
\path (xPal/yB) node[not port] (I0l) {} node[above=0.25cm] {$I_1$}; 
\path (xPal/yA) node[not port] (I1l) {} node[above=0.25cm] {$I_0$}; 
\path (xPcl/yC) node[not port] (I2l) {} node[above=0.25cm] {$I_2$}; 

\path (xPar/yB) node[not port] (I0r) {} node[above=0.25cm] {$I_1'$}; 
...
\path (xPbl/yA) node[nmos,rotate=90] (T1nl) {} node {$T_{0}$};
\path (xPbl/yA) node[pmos,rotate=-90] (T1pl) {};

\path (xPbr/yB) node[nmos,rotate=90] (T0nr) {} node {$T_{1}'$};
\path (xPbr/yB) node[pmos,rotate=-90] (T0pr) {};
\path (xPbr/yA) node[nmos,rotate=90] (T1nr) {} node {$T_{0}'$};
\path (xPbr/yA) node[pmos,rotate=-90] (T1pr) {};
...
\draw (T0nl.S) -- (xMl/yB) -- (xMl/yA) -- (T1nl.S);
\draw (T0nr.S) -- (xMr/yB) -- (xMr/yA) -- (T1nr.S);

\draw (xMl/yC) node[circ] {} -- (I2l.in);
\draw (xMr/yC) node[circ] {} -- (I2r.in);

\draw (I2l.out) -- (xC/yC) node[right] {$Q_M$} -- (xC/yB) -- (I0r.in);
...
\draw (I0l.in) -- (xL |- I0l.in) node[ocirc] {} node[left] {$D$};

\draw (T1nl.G) -- (T0pl.G);
\draw (T1nr.G) -- (T0pr.G);

\draw (xPbl/yC) -- (xPbxl/yC) node[ocirc] {} node[left] {$\CLK$};
\draw (T1pl.G) node[ocirc] {} node[above] {$\CLK*$};
\draw (T0nl.G) node[ocirc] {} node[below] {$\CLK*$};

\draw (xPbr/yC) -- (xPbxr/yC) node[ocirc] {} node[left] {$\CLK*$};
\draw (T1pr.G) node[ocirc] {} node[above] {$\CLK\vphantom{\CLK*}$};
