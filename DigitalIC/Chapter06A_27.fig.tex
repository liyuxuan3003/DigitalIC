...
\path (xL/yBx) node[nmos] (nmosA) {} node {1};
\path (xR/yBx) node[nmos,xscale=-1] (nmosB) {} node {1};
\path (xC/yAa) node[pmos] (pmosA) {} node[right] {4};
\path (xC/yAb) node[pmos] (pmosB) {} node[right] {4};
